...
def main(version, association, cutoff, plot_cutoff, load, compare_with_final):
    ...
    fig.update_layout(
        ...
        yaxis_title='Number of Edge Edits',
        margin=dict(b=50, l=10, r=10, t=10),
        width=width_px,
        height=height_px,
        font=dict(
        family="Serif",
    ...
    fig.write_image(
        './convergence/convergence_{0}-{1}-{2}-{3}.pdf'.format(version, association, cutoff, plot_cutoff), scale=1
    )
